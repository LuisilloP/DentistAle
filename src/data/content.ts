export const seo = {
  siteName: "Clínica Dental Mirador",
  title: "Clínica Dental Mirador | Odontología e implantología en Ovalle",
  description:
    "Atención odontológica integral en Ovalle. Implantología, rehabilitación oral y estética con tecnología moderna y un trato cercano en Clínica Dental Mirador.",
  keywords:
  ...
  ogImage: "/specialbanner.jpg",
  phone: "+56927151566",
  email: "a.bacic.v@gmail.com",
  sameAs: [
    "https://www.instagram.com/clinicadental.sb/",
    "https://web.facebook.com/people/Clinica-Dental-SB/61553382780456/?is_tour_dismissed=true",
  ],
};
...
export const indexCards = [
  {
    ...
    title: "Alejandro Bacic",
    text:
      "Mi pasión es la odontología y mi propósito es entregarte una atención cercana y de alta calidad. Conoce más sobre mí y mi forma de trabajar con un solo clic.",
    button: "Conóceme",
    name: "aboutme",
  },
  {
    image: "/svg/dentalServices.svg",
    title: "Mis servicios",
    text:
      "En mi consulta priorizo una atención personalizada y de alta calidad. Realizo desde controles y limpiezas hasta tratamientos avanzados de restauración y rehabilitación.",
    button: "Ver servicios",
    color: "other",
    name: "services",
  },
  {
    image: "/svg/dentalDate.svg",
    title: "Reserva una hora",
    text: "¿Listo para cuidar tu sonrisa? Agenda tu hora en pocos pasos.",

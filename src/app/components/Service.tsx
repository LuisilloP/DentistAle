                ...
                <div className="group h-[18rem] lg:h-[24rem] w-full rounded  ">
                    <div className="relative h-full w-full rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                        <div className="absolute inset-0">
                            <Image className={`h-[100%] md:h-[18rem] lg:h-[24rem] rounded object-cover shadow-xl shadow-black/40 ${name == 'Rinomodelacion' ? " object-fill" : ""}`} width={700} height={700} src={image} alt={name} />
                        </div>

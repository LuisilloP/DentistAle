            ...
            <h1 className="relative z-20  text-white ">
                <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-5 text-lg md:text-xl'>
                    <div className=''>
                        ...
                        <Link target='__blank' href={"https://wa.me/56927151566?text=Hola,%20Quiero%20agendar%20una%20evaluacion."}
                    ...
                    <div >
                        ...
                        <div className='flex flex-col'>
                            <a href="tel:+56927151566" className='cursor-pointer  '>+56 9 2715 1566</a>

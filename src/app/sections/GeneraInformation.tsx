        ...
        <div className="relative min-h-[20rem] flex flex-col justify-center items-center text-center md:text-start py-5">
            ...
            <h1 className="relative z-20  text-white ">
                <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-5 text-lg md:text-xl'>
                    <div className=''>
                        <h3 className=' font-bold text-2xl md:text-3xl pb-5 aqua-principal'>Agenda</h3>
                    ...
                    <div>
                        <h3 className=' font-bold text-2xl md:text-3xl pb-5 aqua-principal'>Direccion</h3>
                        <h4>Provincial de Ovalle</h4>
                        <h4>Avda. Manuel Peñafiel # 1550</h4>
                    </div>
                    <div >
                        <h3 className=' font-bold text-2xl md:text-3xl pb-5 aqua-principal'>Contacto</h3>
                        <h4>+569 3588 6949</h4>
                        <h4>correoreal@correo.com</h4>
                    </div>
                    <div className=''>
                        <h3 className=' font-bold text-2xl md:text-3xl pb-5 aqua-principal'>Horario</h3>
                        <h4>Lunes-viernes</h4>

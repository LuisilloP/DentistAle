                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div>
                        ...
                        <div className='pt-3 flex gap-3 items-center'>
                            ...
                            <Link href={"https://www.instagram.com"} target='_blank'><Image src={LogoInstagram} width={27} height={27} alt='Logo Instagram' ></Image></Link>
                            <Link href={"https://www.facebook.com"} target='_blank'><Image src={LogoFacebook} width={27} height={27} alt='Logo Facebook' ></Image></Link>
                        </div>
                    </div>
                </div>
